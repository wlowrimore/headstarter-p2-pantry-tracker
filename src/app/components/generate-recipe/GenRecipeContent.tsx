...
import Loading from "../../recipe-generator/loading";
...
import { Avatar, CardHeader, Input } from "@mui/material";
import Image from "next/image";

const GenRecipeContent = () => {
  const [prompt, setPrompt] = useState<string>("");
  const [isLoading, setIsLoading] = useState<boolean>(false);
  const [recipes, setRecipes] = useState<any[]>([]);
  const firstName = useExtractFirstName();
...
export default GenRecipeContent;
